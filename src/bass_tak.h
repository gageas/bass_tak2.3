...
typedef struct
{
	...
	BYTE *prebuf;             // current position of buffer
	BYTE *prebufAlloc;        // alloced buffer memory
	unsigned long prebuflen;  // left data size
	unsigned long prebufSize; // alloced buffer size
